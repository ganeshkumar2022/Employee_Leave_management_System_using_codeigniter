...
include('ad.php');
?>
<h3 class="font-weight-normal text-white p-4">Employee Section&nbsp;&nbsp;&nbsp;
		<span style="font-size:16px;" class="text-dark font-weight-bold">Home / Employee management</span></h3>
	<div class="container-fluid">
		<div class="container py-2" style="background-color:lightgray;">
		  <center>
		     <a class="btn btn-danger" href="<?=base_url('admin/add_employee')?>">Add new Employee</a>
          </center>
		<div class="row">
			<div class="col-md-12">
...
?>
            <tr>
                <td><span class="my-dpt"></span>&nbsp;&nbsp;<?=$employee->firstname." ".$employee->lastname?></td>
                <td><?=$employee->employee_id?></td>
            <td><?=$employee->department?><br>
			<span class="edit-opt" style="display:none;">
			   <a href="<?=base_url('admin/edit_employee/'.$employee->eid)?>"><i class="fa-regular fa-pen-to-square" style="color: #16df37;"></i></a>
			   <a href="<?=base_url('admin/delete_employee/'.$employee->eid)?>"><i class="fa-solid fa-circle-xmark" style="color: #ed230c;"></i></a>
            </span>
		    </td>
                <td><?=$employee->reading_time?></td>
