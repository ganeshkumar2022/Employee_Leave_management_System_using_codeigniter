...
<h3 class="font-weight-normal text-white p-4">Department Section&nbsp;&nbsp;&nbsp;
	...
	<p>Please fill the form to add new department</p>
			<form action="<?=base_url('admin/verify_add_department')?>" method="post" autocomplete="off">
		<div class="form-group">
			<label for="email">Department name:</label>
			<input type="text" class="form-control" name="department_name" placeholder="Enter Department name" required id="email">
		</div>
		<div class="form-group">
			<label for="pwd">Short form:</label>
			<input type="text" class="form-control" name="short_form" placeholder="Enter Short form" required id="pwd">
		</div>
		<div class="form-group">
			<label for="pwd">Code:</label>
			<input type="text" class="form-control" name="code" placeholder="Enter Code" required id="pwd">
		</div>
