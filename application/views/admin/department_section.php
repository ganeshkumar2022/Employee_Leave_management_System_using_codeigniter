...
<h3 class="font-weight-normal text-white p-4">Department Section&nbsp;&nbsp;&nbsp;
		<span style="font-size:16px;" class="text-dark font-weight-bold">Home / Department Management</span></h3>
	<div class="container-fluid">
		<div class="container py-2" style="background-color:lightgray;">
		  <center>
		     <a class="btn btn-danger" href="<?=base_url('admin/add_department')?>">Add new Department</a>
          </center>
		<div class="row">
			<div class="col-md-12">
...
?>
            <tr>
                <td><span class="my-dpt"></span>&nbsp;&nbsp;<?=$employee->department_name?></td>
                <td><?=$employee->short_form?></td>
            <td><?=$employee->code?><br>
			<span class="edit-opt" style="display:none;">
			   <a href="<?=base_url('admin/edit_department/'.$employee->did)?>"><i class="fa-regular fa-pen-to-square" style="color: #16df37;"></i></a>
			   <a href="<?=base_url('admin/delete_department/'.$employee->did)?>"><i class="fa-solid fa-circle-xmark" style="color: #ed230c;"></i></a>
            </span>
		    </td>
